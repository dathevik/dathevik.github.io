...
category: projects
image1: /science/projects/4most_skymap.png
image_caption1: "Sky distribution of known high-redshift quasars from the literature (colored by redshift), shown on a HEALPix Mollweide projection. The shaded southern cap (Dec < −30°) highlights the under-explored southern sky targeted by the 4MOST/ChANGES survey."
...
This project has been [published in **Astronomy & Astrophysics**](https://doi.org/10.1051/0004-6361/202557171){:target="_blank"} (Mkrtchyan et al. 2026, A&A, 710, A170), and the resulting catalog of ~6,000 high-redshift quasar candidates is currently being observed as part of the 4MOST/ChANGES spectroscopic survey. Once all observations are completed, we plan to investigate the spectral properties of the confirmed quasars and construct their luminosity functions. Stay tuned for future updates!

Me at NTT observing high-redshift quasar candidates!
<figure>
  <img src="{{ page.image2 }}" alt="Me at NTT observing high-redshift quasar candidates" width="70%">
</figure>
