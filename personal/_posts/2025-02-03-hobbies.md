...
I also love organizing cooking workshops with friends, each session is dedicated to a different country's cuisine (so far we've cooked our way through Armenia, Slovakia, Brazil, India, Chile, the UK and the US, with many more to come). I'm collecting the recipes and stories from these gatherings into a cookbook of my own,  you can check it out [here](https://canva.link/8d5nhs9t9ccwjdj){:target="_blank"}.

<figure>
  <img src="{{ page.image7 }}" alt="cookbook" style="width: 60%; max-width: 400px; float: center; margin-right: 15px;">
  <figcaption style="text-align: center; font-style: italic; font-size: 0.9em;">
    {{ page.image_caption7 }}
  </figcaption>
</figure>
